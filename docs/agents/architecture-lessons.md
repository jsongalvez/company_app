...
- **Gradle test duration is a first-class architecture signal.** The full backend test gate took 12m50s on 2026-08-18; targeted scheduler tests took 20s. Future agents must audit test discovery, database setup/cleanup, serial bottlenecks, and hangs before adding more integration coverage. Optimize execution without weakening isolation or coverage.
