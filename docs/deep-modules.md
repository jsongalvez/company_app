...
**Anchors:** `service/finance/remittance/RemittanceService.kt`, `service/finance/remittance/RemittancePolicy.kt` (pure rules), `commission/CommissionService.kt` (+ internal `CommissionSplitRepository`, `CommissionManualInclusionRepository` in same package).
