...
- Void/unvoid stickiness on anonymization (#911): void and unvoid write operator free text (the #909 scrub class), so they join the #910 sticky family — both take the client row lock first and reject anonymized clients' sessions with 409 instead of reintroducing the scrubbed reasons. Price/status edits carry no free text and stay allowed (retained, never rewritten).
