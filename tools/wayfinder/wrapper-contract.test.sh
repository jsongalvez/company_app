...
for name in wayfinder-loop.sh wayfinder-create-child.sh wayfinder-verify-child.sh wayfinder-park.sh wayfinder-worker.sh wayfinder-chief.sh wayfinder-workspace.sh; do
