...
private fun RemittanceDetailLinePickerHost(
    ...
    if (dialogs.sessionPicker && branchId != null) {
        val includedIds =
            detail.lines
                .filter { it.type == com.companyb.companyapp.contracts.remittance.RemittanceLineType.SESSION }
...
private fun RemittanceDetailProductSalePickerDialog(
    ...
    if (dialogs.productSalePicker && branchId != null) {
        val includedIds =
            detail.lines
                .filter { it.type == com.companyb.companyapp.contracts.remittance.RemittanceLineType.PRODUCT_SALE }
