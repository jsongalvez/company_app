...
- Standing preference: empty frontier audits the codebase for bugs instead of exiting starved.
...
| Backend module router (owning module, anchors, public seams) | `docs/deep-modules.md` |
| Context discovery discipline (search broadly, read narrowly) | `docs/agents/context-discovery.md` |
...
| Accepted research snapshots (not policy) | `docs/research/` |
